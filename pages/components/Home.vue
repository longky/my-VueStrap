...
qstr += "select  org_id,cust_id,crm_syrid,create_time,name,备注,remark2,中心,负责老师,接待老师,咨询日期,quality,centerid,idchannel,idchannel,idjt,idjt,idcamp,能力,性格,距离,早教 from #tmp where idzx=0;";
 //gt
