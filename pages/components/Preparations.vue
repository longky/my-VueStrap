<template>
  <div class="ui segment">
    <Timeline>
        <Timeline-item color="green" v-for="(key,item) in plans">
    ...
    export default {
		...
		data(){
			return  { 
				...
				"Week17":["(预售当周） 市场：线上活动 点赞有礼","培训师：FS期间梳理中心标准运营流程和管理方式 ；评估中心课程质量，并协助制定培训方向和相关计划，以确保中心的课程质量得以持续提升（相关工具：Q3、FS反馈邮件）"]
				}
			}
		},
		method:{
